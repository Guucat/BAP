...
CREATE TABLE `iip_antibody_sequence` (
  `antibody_sequence__antibody_stru_sequence_id` varchar(100) NOT NULL,
  `antibody_sequence__antibody_stru_id` varchar(100) DEFAULT NULL,
  `antibody_sequence__sequence_id` varchar(100) DEFAULT NULL,
  ...
  KEY `antibody_sequence__antibody_stru_id` (`antibody_sequence__antibody_stru_id`),
  KEY `antibody_sequence__sequence_id` (`antibody_sequence__sequence_id`),
...
-- ----------------------------
INSERT INTO `iip_antibody_sequence` VALUES ('', '2', '2', '轻链', '2');
...
CREATE TABLE `iip_genome` (
  `genome__genome_id` varchar(100) NOT NULL,
  ...
  `genome__genome_ref_id` varchar(100) DEFAULT NULL,
...
CREATE TABLE `iip_genome_2_chr` (
  `genome_2_chr__id` varchar(100) NOT NULL,
  `genome_2_chr__genome_id` varchar(100) DEFAULT NULL,
  ...
  KEY `genome_2_chr__genome_id` (`genome_2_chr__genome_id`),
...
CREATE TABLE `iip_genome_2_gene` (
  ...
  KEY `genome_2_gene__genome_id` (`genome_2_gene__genome_id`),
...
CREATE TABLE `iip_microbe_2_genome` (
  `microbe_2_genome__microbe_genome_id` varchar(100) NOT NULL,
  `microbe_2_genome__microbe_id` varchar(100) DEFAULT NULL,
  ...
  KEY `microbe_2_genome__microbe_id` (`microbe_2_genome__microbe_id`),
